...
Installing pybamm-base
======================

Installing `pybamm-base` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating pybamm-base-feedstock
==============================

If you would like to improve the pybamm-base recipe or build a new
...
Note that all branches in the conda-forge/pybamm-base-feedstock are
